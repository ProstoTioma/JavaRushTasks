...
public class Dog implements Pet {
    ...
    public Sayable toSayable(final int i) {
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                String stroka = null;
                if(i < 1) stroka = getName() + " спит.";
                else  {
                    SimpleDateFormat simpleDateFormat = formatter;
                    int countGaw = i;
                    StringBuilder stringBuilder = new StringBuilder(getName() + " лает г");
                    for(int a = 0; a < countGaw; a++) stringBuilder.append("а");
                    stringBuilder.append("в! " + simpleDateFormat.format(new Date()));
                    stroka = stringBuilder.toString();
                }
